...
(async function testReactApp() {
    ...
    try {
        ...
        let expectedUrl = "http://localhost:3000/pastdata"; // Change as needed
        ...
        let fetchButton = await driver.wait(until.elementLocated(By.id("readbtn")), 5000);
        await fetchButton.click();
        console.log("✅ Fetch button clicked!");

       

            console.log("✅ Test Passed: Data Added successfully!");
